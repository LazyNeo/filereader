...
module.exports = {
  build: {
    ...
    nw: {
      ...
      manifest: ['name', 'appName', 'version', 'description', 'author', { main: './index.html' }, 'manifestUrl', 'window', 'nodejs', 'js-flags', 'node-remote', 'backendVersion'],
      ...
      builder: {
        ...
        winIco: resolve('./build/setup_resources/pos_logo.ico'),
      ...
      upgrade: {
        ...
        publicPath: 'http://shake.m6fresh.com/m6pos/releases/',
        files: [curReleasesPath]
      }
    }
  },
